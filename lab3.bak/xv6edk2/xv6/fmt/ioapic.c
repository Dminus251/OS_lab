...
7860 
7861   // Mark all interrupts edge-triggered, active high, disabled,
7862   // and not routed to any CPUs.
...
7871 {
7872   // Mark interrupt edge-triggered, active high,
7873   // enabled, and routed to the given cpunum,
7874   // which happens to be that cpu's APIC ID.
