...
# -f: 페이지 주소가 담긴 파일의 경로 지정. default: ''
...
# -n: '-a'가 -1인 경우 생성할 주소의 수 지정. default: 10
...
# -p: policy. default: FIFO. 다음 중 선택: FIFO, LRU, OPT, UNOPT, RAND, CLOCK
...
# -b: CLOCK policy에서 사용할 클럭 비트 수. default:2
